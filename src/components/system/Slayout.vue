...
const handleSelect = (key) => {
  ...
  router.push({path:key,query:{id:sys.value.id}}); // 跳转到对应路由
};
  ...
  <el-container class="layout-container">
    <el-header class="header">
      ...
      <el-menu :default-active="activeIndex" class="menu" mode="horizontal" :ellipsis="false" text-color="#fff"
        ...
        <el-menu-item index="/system/index">个人中心</el-menu-item>
        <el-menu-item index="/system/editUser">用户管理</el-menu-item>
        <el-menu-item index="/system/editRoom">房源管理</el-menu-item>
      </el-menu>
      <div class="header-buttons">
        <template v-if="userName">
          <el-dropdown trigger="hover">
            <el-link type="warning" :underline="true" @click="router.push('/user')">您好，{{
                userName
              }}
            </el-link>
            <template #dropdown>
