...
const activeIndex = ref('/maintenance/index')
const handleSelect = (key) => {
  activeIndex.value = key; // 更新当前选中的菜单
  router.push({path:key,query:{id:staff.value.id}}); // 跳转到对应路由
};
  ...
  <el-container class="layout-container">
    <el-header class="header">
      ...
      <el-menu :default-active="activeIndex" class="menu" mode="horizontal" :ellipsis="false" text-color="#fff"
        ...
        <el-menu-item index="/maintenance/index">个人中心</el-menu-item>
        <el-menu-item index="/maintenance/exert">维修列表</el-menu-item>
      </el-menu>
