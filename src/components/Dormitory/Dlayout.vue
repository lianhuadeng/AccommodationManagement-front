  ...
  <el-container class="layout-container">
    <el-header class="header">
      ...
      <el-menu :default-active="activeIndex" class="menu" mode="horizontal" :ellipsis="false" text-color="#fff"
        ...
        <el-menu-item index="/dormitory/index">个人中心</el-menu-item>
        <el-menu-item index="/dormitory/exert">宿舍调整</el-menu-item>
        <el-menu-item index="/dormitory/check">卫生检查</el-menu-item>
        <el-menu-item index="/dormitory/discipline">违纪管理</el-menu-item>
        <el-menu-item index="/dormitory/allocate">维修分配</el-menu-item>
      </el-menu>
